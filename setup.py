...
setup_args = dict(
    install_requires    = ['toolz==0.12.0', 'euclid3 == 0.1', 'descartes == 1.1.0', 'matplotlib == 3.7.1', 'opencv_python == 4.7.0.72'],
    name                = 'Shapely',
    ...
    packages            = [
        ...
        'shapely.speedups',
        'shapely.vectorized',
        'shapely.extension', *[f'shapely.extension.{pkg}' for pkg in find_packages('shapely/extension')],
    ],
    classifiers         = [
