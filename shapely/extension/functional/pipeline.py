...
class Sequence(object):
    ...
    def max(self, **kwargs):
        ...
        If the sequence is empty and default is not provided, a ValueError is raised.
        ...
        :param kwargs: The default,a keyword-only argument, \
        specifies an object to return if the provided sequence is empty
    ...
    def max_by(self, func, **kwargs):
        ...
        >>> seq([]).max_by(lambda x: x, default=1)
        1
        ...
        :param kwargs: the default argument provides object to return if the given iterable is empty
    ...
    def min_by(self, func, **kwargs):
        ...
        >>> seq([]).min_by(lambda x: x, default=-1)
        -1
