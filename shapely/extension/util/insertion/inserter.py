...
@curry
def raster_inserter(insert_geom: BaseGeometry, obstacle: BaseGeometry, scale_factor: float = DEFAULT_SCALE_FACTOR) -> BaseGeometry:
    return obstacle.ext.raster(scale_factor).convolution(insert_geom.ext.raster(scale_factor)).vectorize()
