...
class TestLegalize(TestCase):
    ...
    def test_legalize_linearRing(self):
        ...
        self.assertEqual(legalize(ring1), expect1)
    ...
    def test_legalize_multi(self):
        ...
        self.assertEqual(legalize(multi_linestring), expect2)
        ...
        expect3 = GeometryCollection([Polygon([(1, 0), (0, 0), (0, 1), (1, 1), (2, 1), (2, 0), (1, 0)]),
                                      LineString([(1, 0), (1, 1)])])
        self.assertEqual(legalize(multi_polygon), expect3)
        ...
        expect4 = GeometryCollection([GeometryCollection([Polygon([(0, 1), (2, 0), (0, 0), (0, 1)]),
                                      ...
                                      Point(3, 0),
                                      Point(3, 3)])
        self.assertEqual(legalize(geom_collection), expect4)
